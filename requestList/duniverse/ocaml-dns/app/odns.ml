...
let cmd_a : unit Cmd.t =
  ...
  and info =
    Cmd.info "a" ~version:(Manpage.escape "v7.0.3") ~man ~doc ~sdocs
  in
  Cmd.v info term
...
let cmd_aaaa : unit Cmd.t =
  ...
  and info =
    Cmd.info "aaaa" ~version:(Manpage.escape "v7.0.3") ~man ~doc ~sdocs
  in
  Cmd.v info term
...
let cmd_mx : unit Cmd.t =
  ...
  and info =
    Cmd.info "mx" ~version:(Manpage.escape "v7.0.3") ~man ~doc ~sdocs
  in
  Cmd.v info term
...
let cmd_tlsa : unit Cmd.t =
  ...
  and info =
    Cmd.info "tlsa" ~version:(Manpage.escape "v7.0.3") ~man ~doc ~sdocs
  in
  Cmd.v info term
...
let cmd_txt : unit Cmd.t =
  ...
  and info =
    Cmd.info "txt" ~version:(Manpage.escape "v7.0.3") ~man ~doc ~sdocs
  in
  Cmd.v info term
...
let cmd_any : unit Cmd.t =
  ...
  and info =
    Cmd.info "any" ~version:(Manpage.escape "v7.0.3") ~man ~doc ~sdocs
  in
  Cmd.v info term
...
let cmd_dkim : unit Cmd.t =
  ...
  and info =
    Cmd.info "dkim" ~version:(Manpage.escape "v7.0.3") ~man ~doc ~sdocs
  in
  Cmd.v info term
...
let cmd_type : unit Cmd.t =
  ...
  let term =
    Term.(term_result (const do_type $ nameserver $ arg_typ
                       $ arg_domains $ setup_log))
  and info =
    Cmd.info "type" ~version:(Manpage.escape "v7.0.3") ~doc ~sdocs
  in
  Cmd.v info term
...
let cmd_loc : unit Cmd.t =
  ...
  and info =
    Cmd.info "loc" ~version:(Manpage.escape "v7.0.3") ~doc ~sdocs
  in
  Cmd.v info term
...
|}
  ...
  let info =
    Cmd.info "odns" ~version:(Manpage.escape "v7.0.3") ~man ~doc ~sdocs
  in
